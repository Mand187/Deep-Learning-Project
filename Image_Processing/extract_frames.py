...
def video_to_frames(video_path, frames_dir, overwrite=False, every=1, start=-1, end=-1):
    """
    ...
    extract_frames(video_path, frames_dir, every=every, start=start, end=end)  # let's now extract the frames
