...
def generate_video_from_predictions(
    ...
    IDs_To_Visualize = [9, 11], # ID 11 shows model does not predict car going off screen
    frame_offset = 5 # How many frames to look ahead
):
